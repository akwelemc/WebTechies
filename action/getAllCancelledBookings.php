...
function getAllfCancelledBookings()
{
    global $conn;
    $userId = userIdExist();
    $cancelled_bookings_query = "SELECT Count(*) from CancelledBookings JOIN Bookings ON Bookings.bookingId = CancelledBookings.bookingID;";
