...
function getTotalCompletedBookings()
{
    global $conn;
    $userId = userIdExist();
    $total_completed_bookings_query = "SELECT Count(*) as total_booking from Bookings JOIN BookingStatus ON BookingStatus.status_id = Bookings.bookingStatus where Bookings.pid = $userId AND BookingStatus.status_name = 'Completed';";
